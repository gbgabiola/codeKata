 ...
 *
 * Examples:
 * checkEquality(1, true) ➞ false // A number and a boolean: their type is different
 * checkEquality(0, "0") ➞ false // A number and a string: their type is different
 * checkEquality(1,  1) ➞ true // A number and a number: their type and value are equal
 */
